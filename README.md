...
## Getting Started
1. Download the [required model files](https://huggingface.co/altunenes/parakeet-rs/tree/main/nemotron-3.5-asr-streaming-0.6b-onnx) and place them in the root directory (the multilingual **Nemotron 3.5 ASR streaming 0.6B** model is used)
